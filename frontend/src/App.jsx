                ...
                <Router>
                    <div className="app-container">
                        ...
                        <Routes>
                            ...
                            <Route path="/tourists" element={<ProtectedRoute allowedRoles={['admin', 'police', 'forest']}><TouristList /></ProtectedRoute>} />
                            <Route path="/tourist-list" element={<ProtectedRoute allowedRoles={['admin', 'police', 'forest']}><TouristList /></ProtectedRoute>} />
